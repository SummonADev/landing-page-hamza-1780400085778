        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden">
              <img
                src="https://ewbgpvlexeafgpwsjqei.supabase.co/storage/v1/object/public/prompt-images/build-images/1780400315923-WhatsApp-Image-2026-04-13-at-8.55.33-PM.jpeg"
                alt="Featured"
